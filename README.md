...
<div align="center">
<h3>About Me</h3>
<p style="font-size:11px; max-width:600px; color:#ccc;">
I'm <strong>Sebastián Raúl Villacorta</strong>, a <strong>Computer & Information Science student</strong> passionate about <strong>hardware systems, Linux, and server optimization</strong>.  
I love understanding how things work beneath the surface — building, repairing, and refining technology with purpose.
</p>
<p style="font-size:11px; max-width:600px; color:#ccc;">
Fast learner, adaptive and precise. Focused on <strong>automation</strong>, <strong>system design</strong> and <strong>productivity tools</strong>.  
Currently exploring <strong>AI-driven workflows</strong> and <strong>augmented reality hardware</strong> crafted from recycled components.
</p>
<p style="font-size:10px; font-style:italic; color:#888;">
